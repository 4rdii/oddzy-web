...
faq:
  ...
  - q: "Is this available on Oddzy or do I need Polymarket?"
    a: "The 50 bps September contract, the binary rate-hike market and the gold dip contracts are all on Oddzy. The six hike-count buckets are not currently listed on Oddzy and trade on Polymarket only, so the core and tail layers as described have to be placed there for now. The gold-price hedge described at the end is the version of this trade that is fully available on Oddzy today."
...
[Fed rate hike in 2026 · 71.5%](/market/fed-rate-hike-in-2026)

[50+ bps in September · 0.55%](/market/will-the-fed-increase-interest-rates-by-50-bps-after-the-september-2026-meeting-664)

  </div>
  <div className="oz-cta-note">The full Fed board, meeting by meeting, is on the <a href="/topic/economy-fed">Fed rates topic page</a>. The six hike-count buckets used for the core layer are not listed on Oddzy yet — see the availability note below.</div>
</div>
...
**The buckets are exactly-n, not thresholds.** "Two or more" is not a contract you can buy. You buy one share each of the 2, 3, 4 and 5+ buckets, and that basket costs 29.65c and pays exactly 100c whenever at least two hikes land. Miss one bucket and you have a hole in the cover. The same applies to the tail layer with buckets 3 and up. If you have not built a multi-leg position before, [what a basket is](/learn/what-is-a-basket) covers the mechanics.
...
**Availability, plainly:** of the three layers, only the shock leg is on Oddzy today. The six hike-count buckets that make up the core and tail are listed on Polymarket and are not in Oddzy's market set yet. Everything in the final section is on Oddzy.
