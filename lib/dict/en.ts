...
export const en = {
  ...
  basketBuilder: {
    ...
    h1: "Build a basket",
    lead:
      "Pick 2 to 10 positions, set how the money splits between them, and publish it under your name. Anyone who buys it earns you {pct}% of the fee.",
    loading: "Loading markets…",
    emptyCategory: "No open markets in this category right now.",
    add: "Add to basket",
    added: "Already in your basket",
    yourBasket: "Your basket",
    splitEvenly: "Split evenly",
    dropHere: "Drop markets here",
    dropHint: "2 to 10 positions",
    remove: "Remove",
    weight: "Weight",
    totalWeight: "Total weight",
    bestCase: "If all hit",
    weightWarning: "Weights have to total exactly 100% before you can publish.",
    namePlaceholder: "Name your basket",
    needTwo: "Pick at least 2 positions",
    needHundred: "Weights must total 100%",
    needName: "Name your basket",
    publish: "Publish basket",
    publishing: "Publishing…",
    publishFailed: "That didn't publish. Nothing was saved — try again.",
    signInFirst: "Sign in to publish a basket.",
    tooFast: "You're publishing quickly. Give it a minute.",
    feeNote:
      "Published under your name. You earn {pct}% of the fee on every buy, credited to your balance. Buying your own basket earns nothing.",
    publishedTitle: "Your basket is live",
    publishedBody:
      "Share the link and you earn on every buy. Each position settles on its own, so a buyer doesn't need them all to come in.",
  ...
  match: {
    metaTitle: "{title} — odds and every market",
    metaDescription:
      "{title}: the market gives {leader} {chance}%. Live odds on the result and all {count} markets on this match.",
    metaDescriptionResolved: "{title} — how the result and all {count} markets on this match resolved.",
    kickoff: "Kick-off",
    tehran: "",
    markets: "{count} markets",
    traded: "{volume} traded · 24h",
    resultHeading: "Result · according to the market",
    finalHeading: "Final result",
    win: "{name} win",
    draw: "Draw",
    won: "Won",
    backedBy: "Backed by {volume} traded on the result in the last 24 hours.",
    tradeMatch: "Trade this match",
    boardHeading: "Every market on this match",
    boardLead: "Open a market to see exactly how it resolves.",
    groups: {
      moneyline: "Result",
      total: "Goals",
      spread: "Handicaps",
    ...
    rulesUnavailable: "The rules could not be loaded right now.",
    resolved: "Resolved: {outcome}",
    rulesNote: "Each market settles on its own rules. Open one to read exactly how it resolves.",
    ctaLead: "Take a side on any of these {count} markets, on the web or in Telegram.",
